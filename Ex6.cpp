...
class EX6 : public Test //você cria a sua classe derivada da classe base Test
{
public:
	EX6() {
		...
		CreateBox(20.0f, 40.0f, 1.0f, 1.0f, 1.0f, 0.3f, 0.75f);
...
static int testIndex = RegisterTest("Examples", "EX6", EX6::Create);