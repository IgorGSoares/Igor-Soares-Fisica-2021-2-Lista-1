...
class EX7 : public Test //você cria a sua classe derivada da classe base Test
{
public:
	EX7() {
		// Aqui no construtor você inicializa a cena

		CreateFloor(0.0f, 5.0f, 20.0f, 1.0f);
		CreateFloor(0.0f, 40.0f, 20.0f, 1.0f);

		CreateFloor(-20.0f, 22.0f, 1.0f, 18.0f);
		CreateFloor(20.0f, 22.0f, 1.0f, 18.0f);

		CreateBox(0.0f, 30.0f, 1.0f, 1.0f, 1.0f, 0.3f, 0.75f);
...
static int testIndex = RegisterTest("Examples", "EX7", EX7::Create);